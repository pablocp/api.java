...
import com.wedeploy.api.serializer.impl.TextParser;
...
public class RequestTest {
	...
	public static void setup() {
		...
		SerializerEngine.instance().registerEngines(
			ContentType.TEXT.contentType(), new Engines(null, new TextParser()),
			true);
	}
	...
	public void testBodyBytes() throws Exception {
		...
		request.body("value");
		assertArrayEquals("value".getBytes("UTF-8"), request.bodyBytes());
	}
	...
	public void testFileUploads() {
		...
		assertArrayEquals(fileUploads, request.fileUploads());
	}
