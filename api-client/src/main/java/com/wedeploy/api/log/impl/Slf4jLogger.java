...
/**
 * Default implementation of <code>Logger</code>.
 */
public class Slf4jLogger implements Logger {
	...
	public void debug(String message, Object... values) {
		if (locationAwareLogger != null) {
			locationAwareLogger.log(
				null, FQCN, LocationAwareLogger.DEBUG_INT, message, values,
				null);
		}
		else {
	...
	public void error(String message, Object... values) {
		if (locationAwareLogger != null) {
			locationAwareLogger.log(
				null, FQCN, LocationAwareLogger.ERROR_INT, message, values,
				null);
		}
		else {
	...
	public void info(String message, Object... values) {
		if (locationAwareLogger != null) {
			locationAwareLogger.log(
				null, FQCN, LocationAwareLogger.INFO_INT, message, values,
				null);
		}
		else {
	...
	public void trace(String message, Object... values) {
		if (locationAwareLogger != null) {
			locationAwareLogger.log(
				null, FQCN, LocationAwareLogger.TRACE_INT, message, values,
				null);
		}
		else {
	...
	public void warn(String message, Object... values) {
		if (locationAwareLogger != null) {
			locationAwareLogger.log(
				null, FQCN, LocationAwareLogger.WARN_INT, message, values,
				null);
		}
		else {
			logger.warn(message, values);
